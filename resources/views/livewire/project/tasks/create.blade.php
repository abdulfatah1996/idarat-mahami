    ...
    <div class="row mb-4">
        <div class="col-sm-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">إضافة مهمة جديدة</h4>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card border shadow-sm">
                <div class="card-body">
                    <form wire:submit.prevent="createTask" class="p-4 border rounded shadow-sm bg-white">
                        ...
                        <div class="text-end mt-4">
                            <button type="submit" class="btn btn-primary px-4 py-2">
                                <i class="las la-check-circle me-1"></i> حفظ المهمة
                            </button>
                        </div>
