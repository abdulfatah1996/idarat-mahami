         ...
         <div class="col-lg-12">
             <div class="card">
                 <div class="card-body">
                     ...
                     <form wire:submit.prevent="createProject" class="p-4 border rounded shadow-sm bg-white">

                         <h5 class="mb-4 border-bottom pb-2">
                             <i class="las la-folder-plus me-1 text-primary"></i>
                             إضافة مشروع جديد
                         </h5>
                         ...
                         <div class="text-end mt-4">
                             <button type="submit" class="btn btn-success px-4 py-2">
                                 <i class="las la-plus-circle me-1"></i> حفظ المشروع
                             </button>
                         </div>
                     </form>
